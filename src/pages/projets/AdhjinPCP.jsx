...
import { faPython, faCss3Alt, faGithub, faJs,  } from '@fortawesome/free-brands-svg-icons';
import { SiFlask, SiGit, SiGitlab } from "react-icons/si";
      ...
      <div className="relative container mx-auto px-4 flex flex-col items-center justify-center gap-12">
        <div className="p-8 max-w-3xl w-full text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
            ADHJIN<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">PCP</span>
          </h1>
        </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            ...
            <div className="p-2 w-48 text-center bg-gray-800/40 backdrop-blur-md border border-white/10 rounded-3xl shadow-2xl z-10 cursor-default hover:border-blue-400/30 transition-all">
              <div className="flex items-center justify-center gap-2">
                <SiFlask className="text-white text-xl" />
                <span className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Flask</span>
              </div>
            </div>
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className='flex justify-center cursor-pointer'>
            <button className=' mt-6'><a href='https://github.com/AntoineMouille/ahdjinPCP_iut' className='cursor-pointer'><IconLogo name="Github" link={faGithub}/></a></button>
          </div>
